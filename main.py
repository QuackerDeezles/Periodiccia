...
status = cycle(['Subscribe to QuackerDeezles on YouTube :)', 'p help = Help Command', 'Made by QuackerDeezlesYT#3393', 'An original, informational element bot.'])
